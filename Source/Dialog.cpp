...
void Dialog::resized()
{
    ...
    playButton->setBounds (24, 112, proportionOfWidth (0.4396f), 24);
    stopButton->setBounds (24, 152, proportionOfWidth (0.4396f), 24);
    nextButton->setBounds (getWidth() - 27 - proportionOfWidth (0.4396f), 112, proportionOfWidth (0.4396f), 24);
    previousButton->setBounds (getWidth() - 27 - proportionOfWidth (0.4396f), 152, proportionOfWidth (0.4396f), 24);
...
<JUCER_COMPONENT documentType="Component" className="Dialog" componentName=""
  ...
  <TEXTBUTTON name="new button" id="782524494342ddb2" memberName="playButton"
              virtualName="" explicitFocusOrder="0" pos="24 112 43.981% 24"
  ...
  <TEXTBUTTON name="new button" id="a697f73c0108e251" memberName="stopButton"
              virtualName="" explicitFocusOrder="0" pos="24 152 43.981% 24"
  ...
  <TEXTBUTTON name="new button" id="b87e4e67dd2f57e2" memberName="nextButton"
              virtualName="" explicitFocusOrder="0" pos="27Rr 112 43.981% 24"
  ...
  <TEXTBUTTON name="new button" id="f3a85ddec6b3d359" memberName="previousButton"
              virtualName="" explicitFocusOrder="0" pos="27Rr 152 43.981% 24"
