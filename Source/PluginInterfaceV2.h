...
using PlaylistEntrySelectedFunction
    = void (*)(const char* playerName, int playlist_index, const char* playlistEntryName, double duration);
using PlaylistEntryDurationChangedFunction = void (*)(const char* playerName, int playlist_index, double duration);
using PlaylistEntryNameChangedFunction
    = void (*)(const char* playerName, int playlist_index, const char* playlistEntryName);
